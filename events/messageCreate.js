...
// simple cooldown (10 sec per user)
...
export default {
  ...
  async execute(message, client) {
    ...
    if (!cleanText) {
      return message.reply("Мяу? 😺 Напиши щось.");
    }
        ...
        messages: [
          {
            role: "system",
            content:
              "You are a friendly Ukrainian Discord bot called 'Твій кіт України'. Speak Ukrainian, be cute, helpful, and cat-like."
          },
          {
            role: "user",
            content: cleanText
